...
#ifndef SSES_PLAINDATA_HPP
#define SSES_PLAINDATA_HPP
 ...
 */
template <class T>
struct PlainData : public sses_share::BasicData<T>
{
    using super = sses_share::BasicData<T>;
