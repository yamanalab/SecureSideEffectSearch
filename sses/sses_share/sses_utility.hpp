...
#ifndef SSES_UTILITY_HPP
#define SSES_UTILITY_HPP

#include <string>
#include <vector>

#define SSES_UTILITY_NEWLINE STDSC_LOG_INFO("")
...
std::vector<std::string> get_dirlist(const std::string& dir);
